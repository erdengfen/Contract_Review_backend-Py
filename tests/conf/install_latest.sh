...
Install_Bt(){
	...
	echo "正在下载面板文件,请稍等..................."
	echo "=============================================="
	wget -O panel.zip ${download_Url}/install/src/panel6_latest.zip -T 15
...
#	btpip install -I Flask-SQLAlchemy gevent greenlet --no-cache-dir
	/etc/init.d/bt stop
	sleep 5
	/etc/init.d/bt start 	
	sleep 5
