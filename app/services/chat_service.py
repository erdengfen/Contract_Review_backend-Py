...
#
#
#     async def process_message(self, message: str, user_id: str, session_id: str, action: str = "chat", stance: str = "甲方", intensity: str = "标准") -> Dict[str, Any]:
#         """处理聊天消息"""
#         try:
#             # 获取会话
...
#                                 chunk_content, stance, intensity, review_context
#                             )
#
#                             # 保存审阅结果
